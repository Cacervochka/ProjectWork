<div class="authForm">
    ...
    <div class="auth-heading">
        <p data-i18n="auth.login.eyebrow">Welcome back</p>
        <h1 data-i18n="auth.login.title">Member Login</h1>
    </div>
    ...
    <form method="post" action="profile.php">
        ...
        <button type="submit" name="login" data-i18n="auth.login.button">Log In</button>
    </form>

    <div class="auth-footer">
        <p class="note"><span data-i18n="auth.login.new">New here?</span> <a href="authorisation.php?action=2" data-i18n="auth.login.register">Register an account</a></p>
